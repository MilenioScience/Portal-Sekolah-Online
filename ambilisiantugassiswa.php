<?php
 ...
 {
	 $sql = "SELECT hari, namaguru, mapel, idsoal, soal, pilihana, pilihanb, pilihanc, pilihand ";
	 $sql .= "FROM buatsoal ";
 ...
 WHILE($row = $hasil->fetch_row())
 {
	 ...
	 $nestedData[] = $row[7];
	 $nestedData[] = $row[8];
	 $nestedData[] = '<a href="?kode=jawabtugas&idsoal='.$row[3].'"<button type="button" class="btn btn-primary">Jawab</button></a>';
	 $data[] = $nestedData;
 }
