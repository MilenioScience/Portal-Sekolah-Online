...
<body class="bg-gradient-primary">
                ...
                <div class="p-5">
                  ...
                  <form class="user" id="formlogin">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="isian" name="isian"  placeholder="Masukkan Nama/Email...">
                    </div>
                    <div class="form-group">
  ...
  <script src="sbadmin/vendor/bootbox/bootbox.min.js"></script>
		 ...
		 if (hasilProses != '') 
		 {
			 ...
			 bootbox.alert({
				 ...
				 callback : function(result){
					 window.location.href = "teacher-profile2.html";
				 }
			 });
			 }
