		...
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
					<h2 class="title-head">Daftar Akun Guru </h2>
					<p>Daftar Sebagai Siswa <a href="registersiswa.php">Klik Disini</a></p>
				</div>	
				<form class="contact-bx" method = "GET" name = "formisi" id="formisi">
					<div class="row placeani">
						...
						<div class="col-lg-12">
							<div class="form-group">
								<div class="input-group">
									<label>Masukkan Mata Pelajaran yang anda ajar</label>
									<input type="text" name="isimapel" id="isimapel" class="form-control">
								</div>
							</div>
						</div>
						<div class="col-lg-12">
						...
						<div class="col-lg-12">
							<div class="form-group">
								<div class="input-group"> 
									...
									<input type="password" name="kodeunikguru" id="kodeunikguru" class="form-control" >
								</div>
							</div>
						</div>
