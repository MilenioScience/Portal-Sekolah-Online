	...
	<header class="ttr-header">
		<div class="ttr-header-wrapper">
			...
			<div class="ttr-header-right ttr-with-seperator">
				...
				<ul class="ttr-header-navigation">
					<li>
						<a href="#" class="ttr-material-button ttr-submenu-toggle">ADMIN</a>
				    </li>
					<li>
			...
			<nav class="ttr-sidebar-navi">
				<ul>
					<li>
						...
						<ul>
		                	<li>
		                		<a href="?kode=jadwalpelajaran" class="ttr-material-button"><span class="ttr-label">Entry Jadwal Pelajaran</span></a>
		                	</li>
		                	<li>
		                		<a href="?kode=tampiljadwalpelajaran" class="ttr-material-button"><span class="ttr-label">Tampil Jadwal Pelajaran</span></a>
		                	</li>
		                </ul>
		            </li>
					<li>
...
<?php
 if (isset($_GET['kode']))
 {
	 ...
	 {
		include('isijadwalpelajaran.php'); 
	 }
	 else if ($kode == 'tampiljadwalpelajaran')
	 {
		include('tampiljadwalpelajaran.php'); 
	 }
	 else if ($kode == 'editjadwalpelajaran')
	 {
		include('editjadwalpelajaran.php'); 
	 }
 }
?>	
