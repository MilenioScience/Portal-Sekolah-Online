...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="admin/fonts/flaticon/font/flaticon.css">
        ...
        <div class="container mb-3">
          <div class="d-flex align-items-center">
            <div class="site-logo mr-auto">
              <a href="halamanawal.php">Portal Sekolah Online</a>
            </div>
          </div>
        </div>
            ...
            <span class="d-inline-block d-lg-none"><a href="#" class="text-black site-menu-toggle js-menu-toggle py-5"><span class="icon-menu h3 text-black"></span></a></span>
              ...
              <nav class="site-navigation text-left mr-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav mr-auto ">
                  <li class="active"><a href="index2.html" class="nav-link">Home</a></li>
              ...
              <div class="top-social ml-auto">
                ...
                <a href="registersiswa.php"><span>Daftar</span></a>				
              </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row align-items-center ">
            <div class="col-md-5 mt-5 pt-5">
              ...
              <h1 class="mb-3 font-weight-bold text-teal">Belajar Bersama Sekarang Lebih Mudah</h1>
              <p class="mt-5"><a href="#" class="btn btn-primary py-4 btn-custom-1">Pelajari Lebih Lanjut</a></p>
            </div>
            <div class="col-md-6 ml-auto align-self-end">
              <img src="admin/images/kid_transparent.png" alt="Image" class="img-fluid">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="block-2 red">
              ...
              <h2>Efisien</h2>
              <p>Dengan menggunakan fasilitas portal sekolah online, segala macam aktifitas di sekolah dapat dilakukan secara online disini, sehingga akan memberikan efisiensi terhadap pihak sekolah</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="block-2 yellow">
              ...
              <h2>Fleksibel</h2>
              <p>Fasilitas yang ada di portal sekolah online, memungkinkan pihak sekolah untuk mengatur secara mandiri oleh pihak sekolah</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="block-2 teal">
              ...
              <h2>Terstruktur</h2>
              <p>Tidak perlu lagi menggunakan sumber daya seperti kertas, dan atk yang berlebih, dalam portal sekolah online ini, pihak sekolah dapat melakukan segala bentuk aktifitas sekolah seperti biasanya</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            <img src="admin/images/img_1.jpg" alt="Image" class="img-fluid">
          </div>
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="admin/images/flaticon/svg/001-jigsaw.svg" alt="Image" class="img-fluid"></span>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="admin/images/flaticon/svg/002-target.svg" alt="Image" class="img-fluid"></span>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="admin/images/flaticon/svg/003-mission.svg" alt="Image" class="img-fluid"></span>
              ...
              <div class="owl-carousel nonloop-block-13">
                <div class="testimonial-3 d-flex">
                  <div class="vcard-wrap mr-5">
                    <img src="admin/images/person_1.jpg" alt="Image" class="vcard img-fluid">
                  </div>
                  <div class="text">
                    <h3>Jeff Woodland</h3>
                ...
                <div class="testimonial-3 d-flex">
                  <div class="vcard-wrap mr-5">
                    <img src="admin/images/person_3.jpg" alt="Image" class="vcard img-fluid">
                  </div>
                  <div class="text">
                    <h3>Jeff Woodland</h3>
                    <p class="position">Partner</p>
                ...
                <div class="testimonial-3 d-flex">
                  <div class="vcard-wrap mr-5">
                    <img src="admin/images/person_2.jpg" alt="Image" class="vcard img-fluid">
                  </div>
                  <div class="text">
                    <h3>Jeff Woodland</h3>
                    <p class="position">Partner</p>
    ...
    <div class="site-section py-5 bg-warning">
      <div class="container">
        <div class="row justify-content-center">
          ...
          <h2 class="text-white m-0">Ayo Belajar Bersama</h2>
          <a href="#" class="btn btn-primary btn-custom-1 py-3 px-5 ml-auto">Klik Disini</a>
          </div>
        </div>
      </div>
    </div>
